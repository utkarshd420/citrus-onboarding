...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'merchant_bank_details'
        db.create_table(u'signup_merchant_bank_details', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('merchant', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['signup.Merchant'])),
            ('bank_name', self.gf('django.db.models.fields.CharField')(max_length=200)),
            ('branch_name', self.gf('django.db.models.fields.CharField')(max_length=300)),
            ('ifsc_code', self.gf('django.db.models.fields.CharField')(max_length=20)),
            ('account_number', self.gf('django.db.models.fields.CharField')(max_length=30)),
        ))
        db.send_create_signal(u'signup', ['merchant_bank_details'])

        # Adding field 'Txn.verification_amount_sent_date'
        db.add_column(u'signup_txn', 'verification_amount_sent_date',
                      self.gf('django.db.models.fields.DateTimeField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting model 'merchant_bank_details'
        db.delete_table(u'signup_merchant_bank_details')

        # Deleting field 'Txn.verification_amount_sent_date'
        db.delete_column(u'signup_txn', 'verification_amount_sent_date')
    ...
    models = {
        ...
        u'signup.document_user_status': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'join_date': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 0, 0)'}),
            'last_reminder': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 0, 0)'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['signup.Merchant']"}),
            'type': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
        ...
        u'signup.merchant': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_changed_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2014, 7, 7, 0, 0)'}),
        ...
        u'signup.merchant_bank_details': {
            'Meta': {'object_name': 'merchant_bank_details'},
            'account_number': ('django.db.models.fields.CharField', [], {'max_length': '30'}),
            'bank_name': ('django.db.models.fields.CharField', [], {'max_length': '200'}),
            'branch_name': ('django.db.models.fields.CharField', [], {'max_length': '300'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'ifsc_code': ('django.db.models.fields.CharField', [], {'max_length': '20'}),
            'merchant': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['signup.Merchant']"})
        },
        ...
        u'signup.txn': {
            ...
            'status': ('django.db.models.fields.CharField', [], {'default': "'P'", 'max_length': '2', 'db_index': 'True'}),
            'verification_amount': ('django.db.models.fields.DecimalField', [], {'default': '2.395631850189127', 'max_digits': '5', 'decimal_places': '2'}),
            'verification_amount_sent_date': ('django.db.models.fields.DateTimeField', [], {'null': 'True', 'blank': 'True'})
        }
    }
